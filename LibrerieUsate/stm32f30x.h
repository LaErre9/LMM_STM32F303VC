...
typedef struct
{
  __IO uint32_t CR;         /*!< RCC_AHBENR_GPIOEEN clock control register,                                  Address offset: 0x00 */
...
#define SYSCFG_CFGR1_TIM_CR1_CEN7DAC2_DMA_RMP       ((uint32_t)0x00004000) /*!< Timer 7 / DAC2 DMA remap */
